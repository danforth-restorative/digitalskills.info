...
thumbnail-img: /assets/img/noun_Management_Skills_1327063.webp
share-img: /assets/img/digitalskills_og.webp
last-updated: 2020-12-18
---

![Digital transformation for the rest of us.](/assets/img/digital-transformation-for-the-rest-of-us.webp "Digital transformation for the rest of us.")
...
<center><img src="/assets/img/digital-transformation-2014-25_statistica.webp"/></center>
...
![](/assets/img/digitalskills_inline.webp)
...
<center><img src="/assets/img/CBwordcloud.webp"/><br>
<sup><a href="https://commons.wikimedia.org/wiki/File:CBwordcloud.webp">CC-BY-SA Cristinapilataxi</a></sup></center>
...
The most fundamental digital skills, in my estimation, are [web search and curation]({% post_url 2020-11-14-google-search-learning-new-difficult-subjects %}). Much of our curriculum will revolve around finding useful information online, along with any number of pursuits that can be explored while developing those skills.
...
<center><img src="/assets/img/carlos-irineu-da-costa-eMc0lpn1P60-unsplash.webp"/>
...
After running other peoples code for long enough, eventually I learned enough to change a single parameter, slightly altering the code to suit my purpose. One day I wanted to create a [Twitter quote bot](https://github.com/danforth-restorative/GitHub-Actions-Quote-Bot), and discovered I could write a script from start to finish, and set it up to run on a schedule for free with GitHub actions.
...
<center><img src="/assets/img/communication-2805785_1280_ptra.webp"/>
<sup><a href="https://pixabay.com/users/ptra-359668/">by ptra</a></sup></center>

## Stay in touch

Over the coming year, i'll be releasing a number of projects and articles to make the value of [DigitalSkills.Info](https://digitalskills.info) more tangible. 
...
Before I go. Lately, I've been binge listening to the [IndieHackers Podcast](https://www.indiehackers.com/podcasts), which has lots of interviews with solo-founders who go into detail about how they started a business online. It's definitely been an inspiration for me while working on this idea. Highly Recommend.
